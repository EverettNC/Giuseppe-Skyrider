...
from base_synthesizer import SynthesisResult
from config import Tier

try:
    from shorty_voice_engine_v2 import ShortyVoiceEngine
except ImportError:  # pragma: no cover - fallback until Shorty engine lands
    from gpt_sovits_engine import GPTSoVITSEngine as ShortyVoiceEngine
